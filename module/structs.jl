...
mutable struct Population
    ...
    ind_reps_src::Array{Bool, 1}        # update individual reps based on individual (1) or group (0) reputation
    # Group reputations
    ...
    grp_reps_src::Array{Bool, 1}        # update group reps based on individual (1) or group (0) reputation
